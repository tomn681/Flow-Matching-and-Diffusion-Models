...
def _builtin_families():
    ...
    return [
        ...
        ModelFamily("residual_flow_matching", ("residual_flow_matching",), "residual_flow_matching", "residual_flow_matching", "residual_flow_matching", runtime_kind="generative", prediction_types=("epsilon",)),
        ...
        ModelFamily("residual_rectified_flow", ("residual_rectified_flow",), "residual_rectified_flow", "residual_rectified_flow", "residual_rectified_flow", runtime_kind="generative", prediction_types=("epsilon",)),
        ModelFamily("reflow", ("reflow",), "reflow", "reflow", "reflow", runtime_kind="generative", prediction_types=("epsilon",)),
        ModelFamily("consistency", ("consistency",), "consistency", "consistency", "consistency", runtime_kind="generative", prediction_types=("sample",)),
        ModelFamily("x0_denoising", ("x0_denoising",), "x0_denoising", "x0_denoising", "x0_denoising", runtime_kind="generative", prediction_types=("sample",)),
        ModelFamily("edm", ("edm",), "edm", "edm", "edm", runtime_kind="generative", prediction_types=("sample",)),
